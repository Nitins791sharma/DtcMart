                    ...
                    <div className="row gx-0 align-items-center" style={{ height: "45px" }}>
                        <div className="col-lg-8 text-center text-lg-start mb-lg-0">
                            <div className="d-flex flex-wrap">
                                <Link to="tel:+919873848046" className="text-light me-4 d-none d-xl-block"><i className="fas fa-phone-alt text-light me-2"></i>+91-9873848046</Link>
                                <Link to="mailto:vishankchauhan@gmail.com" className="text-light me-4"><i className="fas fa-envelope text-light me-2"></i>vishankchauhan@gmail.com</Link>
                                <Link to="http://wa.me/+919873848046" className="text-light me-4"><i className="fa fa-whatsapp text-light me-2"></i>+91-9873848046</Link>
                            </div>
                        </div>
